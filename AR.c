...
int main(int argc, const char* argv[])
{
	...
	printf("SK KEY SIZE : %d\n",BN_num_bytes(SK->N)+BN_num_bytes(SK->Y)+BN_num_bytes(SK->sk)+sizeof(SK->T)+sizeof(SK->i));
	printf("ID KEY SIZE : %d\n",BN_num_bytes(ID->Id));


	printf("Setup Average tiem(10 time) : %f\n",total_setup);
	printf("Keyissue Average tiem(10 time) : %f\n",total_keyIssue);
	printf("Sign Average tiem(10 time) : %f\n",total_sign);
	printf("Verify Average tiem(10 time) : %f\n",total_verify);
	printf("MSAKupdate Average tiem(10 time) : %f\n",total_mskupdate);
	printf("UKupdate Average tiem(10 time) : %f\n",total_ukupdate);
	return 0;
}
