...
//	printf("%d\n", gPubKey->depth);
	...
	printf("T is %d\t", gPubKey->T);
		
	start = clock();
	setup();
	end = clock();
	printf("setup time : %f\t", (float)(end-start)/CLOCKS_PER_SEC);
	...
	printf("sign time : %f\t", (float)(end-start)/CLOCKS_PER_SEC);
	start = clock();
		update();
	}

	end = clock();
	printf("update time : %f\t", (float)(end-start)/CLOCKS_PER_SEC);
...
//			printf("sign[%d] is invalid\n", i);
	...
	printf("verify time : %f\t", (float)(end-start)/CLOCKS_PER_SEC);
